      ...
      <section className="border-b border-border px-6 pb-20 pt-16">
        <div className="mx-auto max-w-5xl">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              <p className="text-base font-medium text-primary">{t("sharedEss.heroLabel")}</p>
      ...
      <section className="border-t border-border bg-surface px-6 py-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div>
              <h3 className="text-base font-medium text-primary">{t("sharedEss.projectGoalsLabel")}</h3>
            ...
            <div>
              <h3 className="text-base font-medium text-primary">{t("sharedEss.projectBuildLabel")}</h3>
            ...
            <div className="space-y-6">
              {timelineItems.map((item, i) => (
                <div key={i} className="relative flex items-start gap-4 md:gap-6">
                  <div className="shrink-0 w-16 pt-0.5 text-right hidden md:block">
