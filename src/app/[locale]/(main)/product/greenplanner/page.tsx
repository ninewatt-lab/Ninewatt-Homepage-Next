...
export async function generateMetadata({
  ...
  return buildMetadata({
    locale,
    path: "/product/greenplanner",
    title: t("meta.greenplanner.title"),
    description: t("meta.greenplanner.description"),
  });
}
...
export default async function GreenPlannerPage() {
  ...
  return (
    ...
    <ProductJsonLd
      path="/product/greenplanner"
      metaKey="meta.greenplanner"
      category="Green Remodeling Simulation"
    />
