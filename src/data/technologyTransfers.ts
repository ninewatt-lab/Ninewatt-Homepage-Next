...
export const technologyTransfers: TechnologyTransfer[] = [
  ...
  {
    id: 7,
    title: "피크 요금제 시행일 선정 장치 및 그 방법",
    region: "국내",
    applicationNo: "10-2012-0108852",
    transferDate: "2026.02.09",
    registrationNo: "10-2019188",
    transferType: "기술이전",
    institution: "한국전력공사",
    period: "",
    detail: {
      applicationNo: "1020120108852",
      applicationDate: "2012.09.28",
      applicant: "한국전력공사",
      registrationNo: "1020191880000",
      registrationDate: "2019.09.06",
      legalStatus: "등록",
      abstract: "과거 수요실적데이터를 토대로 익일 시간대별 전력 수요값을 예측하고, 과거 발전실적데이터를 토대로 익일 시간대별 발전 계획값을 예측하여 피크 요금제 시행일을 선정하는 장치 및 방법이다. 수요 및 발전 예측, 피크값 추출, 과거 데이터 분석을 통해 전력수급 안정화를 목표로 한다.",
    },
  },
  {
    id: 8,
    title: "신재생에너지 연계계통의 계통정보 표시 장치 및 방법",
    region: "국내",
    applicationNo: "10-2012-0105361",
    transferDate: "2026.02.09",
    registrationNo: "10-2014416",
    transferType: "기술이전",
    institution: "한국전력공사",
    period: "",
    detail: {
      applicationNo: "1020120105361",
      applicationDate: "2012.09.21",
      applicant: "한국전력공사",
      registrationNo: "1020144160000",
      registrationDate: "2019.08.26",
      legalStatus: "등록",
      abstract: "신재생에너지 연계계통의 계통정보를 표시하는 장치 및 방법이다. Pipe Line Diagram(PLD) 형식을 통해 구간별 전력 조류 정보 및 전력 품질 정보를 시각화하여 표시함으로써, 기존 단선결선도 방식 대비 신재생에너지 연계 계통의 전력 흐름과 전력 품질을 효율적으로 분석할 수 있다.",
    },
  },
];
